const options = {
    ...
    data: function () {
      return {
        ...
        webp:["01","02","03","04","05","06","07","08","11","12","13","14","15","16","17",
    ...
    template: /*html*/`
      <q-page>
        ...
        <b-container title="Meteo">
          <div class="bg-blue-1 q-pa-md row items-start">
            <div v-for="(item,id) in webp" :key="id">
            <img :src="'/asset/'+item+'-m.webp'" :alt="item+'-m.webp'">  
            </div>
          </div>
        </b-container>
...
Vue.component("b-config-admin", {
    ...
    methods: {
        ...
        onSubmit() {
            this.configAdmin({ name: this.name, pass: this.pass });
        },
        onReset() {
            this.name = null;
            this.pass = null;
...
Vue.component("b-config-wifi", {
    ...
    methods: {
        ...
        onSubmit() {
            this.configWeather({ name: this.name, pass: this.pass });
        },
        onReset() {
            this.name = null;
            this.pass = null;
